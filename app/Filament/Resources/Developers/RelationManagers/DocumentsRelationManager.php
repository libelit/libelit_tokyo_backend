        ...
        return $schema
            ->components([
                Select::make('document_type')
                    ->options([
                        DocumentTypeEnum::KYB_CERTIFICATE->value => 'KYB Certificate',
                        DocumentTypeEnum::KYB_ID->value => 'KYB ID',
                        DocumentTypeEnum::KYB_ADDRESS_PROOF->value => 'Address Proof',
                        DocumentTypeEnum::KYB_FINANCIAL_STATEMENT->value => 'Financial Statement',
                    ])
                    ->required(),
